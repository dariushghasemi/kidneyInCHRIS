...
vcfReg_TSHmod <-
  ...
  filter(
    # Finally, 416 cases were removed after imposing below filtering
  ...
  mutate(TSH_cat = replace(TSH_cat, Thyroid_DrugName == "Iodine therapy",       "HyperT"), # no cases taking iodine therapy
